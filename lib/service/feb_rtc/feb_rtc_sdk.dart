...
// import 'package:focus/core/local/local.dart';
import 'entity.dart';
  ...
  static Future<bool> startForegroundService() async {
    ...
    try {
      if(WebRTC.platformIsAndroid) {
        ...
        //   notificationText: Consts.backgroundServiceText,
...
class FebRtcSdkValue {
  ...
  FebRtcPeerConfig get config => FebRtcPeerConfig(
    ...
    face: face,
    user: User(
      id: LocalStorage.getUID()
    )
  );

  FebRtcSdkValue(
      {this.stream, this.renderer, this.voice = false, this.video = false, required this.userId});
}
