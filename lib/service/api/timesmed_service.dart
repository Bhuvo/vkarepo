...
part 'timesmed_service.chopper.dart';

@ChopperApi(baseUrl: Consts.BASE_URL_2)
abstract class TimesmedService extends ChopperService {
...
//TimesmedService apiService = TimesmedService.create();
