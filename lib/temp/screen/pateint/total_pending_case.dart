...
class TotalPendingCasePage extends StatefulWidget {
  const TotalPendingCasePage({Key? key, required this.title}) : super(key: key);
...
class _TotalPendingCasePageState extends State<TotalPendingCasePage> {
                          ...
                          child: ListTile(
                            onTap: () {
                              Navigator.of(context).push(MaterialPageRoute(
                                  builder: (context) => AddInrDetailsPage(title: '',)));
                            },
                            title: Stack(
                              children: <Widget>[
                                Container(
