...
import 'package:timesmedlite/temp/screen/pateint/schedule_list.dart';



class TotalPendingCasePage1 extends StatefulWidget {
  const TotalPendingCasePage1({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  _TotalPendingCasePageState createState() => _TotalPendingCasePageState();
}

class _TotalPendingCasePageState extends State<TotalPendingCasePage1> {
                ...
                child: Stack(children: <Widget>[
                  ...
                  Align(
                      ...
                      child: Container(
                          ...
                          child: Text(
                            "Total Pending Case".toUpperCase(),
                            style: TextStyle(
                                color: Colors.white,
                                fontSize: 16.0,
