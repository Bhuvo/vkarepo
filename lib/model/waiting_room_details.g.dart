...
_$_WaitingRoomDetails _$$_WaitingRoomDetailsFromJson(
    ...
    _$_WaitingRoomDetails(
      ...
      startSplit: json['startSplit'] as int,
      endSplit: json['endSplit'] as int,
      toTime: json['toTime'],
      day: json['day'],
      ...
      labtestId: json['labtestId'] as int,
      ...
      cancelalertHour: json['cancelalertHour'] as int,
      ...
      rApp: json['rApp'] as int,
      cApp: json['cApp'] as int,
...
Map<String, dynamic> _$$_WaitingRoomDetailsToJson(
        _$_WaitingRoomDetails instance) =>
    <String, dynamic>{
