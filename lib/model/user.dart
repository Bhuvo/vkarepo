...
class User with _$User {
  const factory User({
    ...
    @JsonKey(name: 'Patient_Registration_Number') @Default(null) dynamic patientregistrationnumber,
    ...
    @JsonKey(name: 'Doctor_ActiveFlag') @Default(null) dynamic doctorActivationflag,
    @JsonKey(name: 'Patient_ActiveFlag') @Default(null) dynamic patientActivationflag,
    @JsonKey(name: 'PatientRegistration_list') @Default(null) dynamic patientRegistrationlist,
