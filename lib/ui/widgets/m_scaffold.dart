...
class MScaffold extends StatelessWidget {
  final Widget? title, drawer, leading, appBarBottom, body, bottom, customHeader;
            ...
            child: Stack(
              children: [
                ...
                Positioned(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 16),
                      child: Image.asset('assets/images/app_bar_bg.png', fit: BoxFit.fitWidth,),
                    )),
                Material(
                  type: MaterialType.transparency,
                  child: customHeader ?? SingleChildScrollView(
                    child: Column(
                            ...
                            child: LayoutBuilder(
                                builder: (context, _) {
                                  return AppBar(
                                    ...
                                    leading: !automaticallyImplyLeading ? null : drawer != null ? IconButton(onPressed: (){
                                      Scaffold.of(context).openDrawer();
                                    }, icon: const Icon(FontAwesomeIcons.bars))
                                        : Navigator.of(context).canPop() ? IconButton(onPressed: (){

                                      context.pop();
                                    }, icon: const Icon(CupertinoIcons.back)) : null
                                    ,
                                    actions: [
                                      ...?actions,
    ...
    final foot = Align(
      ...
      child: ClipPath(
        clipper: const CustomClipPath(
            type: CustomClipPathType.top, radius: 40),
        child: Container(
