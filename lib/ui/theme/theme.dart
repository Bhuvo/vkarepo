...
class MTheme {
  ...
  static const Color THEME_COLOR = Color(0xff0b9b92);
  static const Gradient GRADIENT = LinearGradient(
      colors: [Color(0xff0b9b92), Color(0xff1ec270)],
  ...
  static final ThemeData lightTheme = ThemeData(
      ...
      checkboxTheme: const CheckboxThemeData(
        side:  BorderSide(color: THEME_COLOR)
      ),
      ...
      bottomNavigationBarTheme: const BottomNavigationBarThemeData(
        ...
        selectedItemColor: Colors.white,
          ...
          unselectedLabelStyle: TextStyle(fontSize: 8, fontWeight: FontWeight.w600),
      ),
      ...
      textButtonTheme: TextButtonThemeData(
        style: TextButton.styleFrom(
          //primary: THEME_COLOR,
          textStyle: TextStyle(fontSize: 13, color: THEME_COLOR, fontWeight: FontWeight.w600 )
        ),
