...
bool isLoading = false;
  getData()async{
    ...
    await controller.getLabOrderList(context,LocalStorage.getUID());
    setState(() {
      isLoading = false;
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return MScaffold(
      ...
      body: SingleChildScrollView(
        child:isLoading? Center(child: LoadingWidget()): Column(
          children: [
            Text('Lab Orders'.toUpperCase(),style: const TextStyle(fontWeight: FontWeight.w700,fontSize: 16),),
            controller.labOrderModel.data?.length ==0 || controller.labOrderModel.data == null ? const NothingWidget(
