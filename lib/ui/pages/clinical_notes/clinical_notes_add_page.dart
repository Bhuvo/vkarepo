...
class ClinicalNotesAddPage extends StatefulWidget {
  //final ClinicalNotesLoadSummary? data;
  final String? doctorID;
  final String? userID;
  final String? appointmentID;
  const ClinicalNotesAddPage({Key? key,this.doctorID,this.userID,this.appointmentID}) : super(key: key);

  @override
  State<ClinicalNotesAddPage> createState() => _ClinicalNotesAddPageState();
}

class _ClinicalNotesAddPageState extends State<ClinicalNotesAddPage> {

  double height =170.0, weight=80 , pulse=0 ,temp =0;

  late final disease_name_text_controller = TextEditingController();
  late final allergies_text_controller = TextEditingController();
  late final symptoms_text_controller = TextEditingController( );
  late final diagnoses_text_controller = TextEditingController();
  late final causes_text_controller = TextEditingController();
  late final investigation_text_controller = TextEditingController();
  late final notes_text_controller = TextEditingController( );
  @override
