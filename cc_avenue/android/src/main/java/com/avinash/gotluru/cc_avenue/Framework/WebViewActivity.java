    ...
    private class RenderView extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            try {
                ...
                System.out.println(AvenuesParams.ACCESS_CODE + mainIntent.getStringExtra(AvenuesParams.ACCESS_CODE));
                System.out.println(AvenuesParams.MERCHANT_ID + mainIntent.getStringExtra(AvenuesParams.MERCHANT_ID));
                System.out.println(AvenuesParams.ORDER_ID + mainIntent.getStringExtra(AvenuesParams.ORDER_ID ));
                System.out.println(AvenuesParams.REDIRECT_URL + mainIntent.getStringExtra(AvenuesParams.REDIRECT_URL));
                System.out.println(AvenuesParams.CANCEL_URL+ mainIntent.getStringExtra(AvenuesParams.CANCEL_URL));
                System.out.println(AvenuesParams.ENC_VAL + encVal);
